...
/*INSERIR USUARIO NIVEL 3*/;
INSERT INTO usuarios (nome,usuario,senha,nivel) VALUES ('administrador', 'admin','admin',3);

/*INSERIR OS STATUS DOS EQUIPAMENTOS*/;
INSERT INTO `status`(`id_status`, `nome_status`) VALUES (1,'ATIVO');
INSERT INTO `status`(`id_status`, `nome_status`) VALUES (2,'ESTOQUE');
INSERT INTO `status`(`id_status`, `nome_status`) VALUES (3,'DANIFICADO');